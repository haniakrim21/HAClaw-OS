...
export async function POST(request: Request) {
  ...
  const system = [
    ...
    '',
    'Available actions:',
    '1. Navigate: {"k":"navigate","to":"/tasks"}  (allowed: /today, /news, /tasks, /deliveries, /notes, /settings, /settings/telegram, /settings/password)',
    ...
    '14. Create process: {"k":"process.create","title":"Morning digest","schedule":"0 9 * * *","actionType":"send_digest","description":"Optional"}',
    '15. List processes: {"k":"process.list"}',
    '16. Toggle process on/off: {"k":"process.toggle","processId":"uuid-here"}',
    '17. Delete process: {"k":"process.delete","processId":"uuid-here"}',
    '18. Create note: {"k":"note.create","title":"Note title","content":"Multi-line text\\nSecond paragraph","tags":["tag1"],"isPinned":false}',
    '19. List notes: {"k":"note.list","search":"optional search query"}',
    '20. Read note: {"k":"note.read","noteId":"uuid-here"} — returns full content as markdown',
    '21. Update note: {"k":"note.update","noteId":"uuid-here","title":"New title","content":"New text","tags":["new"],"isPinned":true}',
    '22. Export note as markdown: {"k":"note.export","noteId":"uuid-here"} — returns markdown text (use for sending to Telegram)',
    '23. Delete note: {"k":"note.delete","noteId":"uuid-here"}',
    '',
    'Notes workflow:',
    '- When asked to create a note: ALWAYS set a meaningful title and write actual content text. Use \\n for paragraph breaks.',
    '- When asked to read/show a note: first use note.list to find it, then note.read to get content.',
    '- When asked to edit a note: use note.read first to see current content, then note.update with changes.',
    '- When asked to export/send a note to Telegram: use note.export to get markdown, then include it in your response.',
    '- When asked to open notes: navigate to /notes. To open a specific note, navigate to /notes and mention the note title.',
    '',
    'Process schedule uses cron format. Common examples:',
    '- Every day at 9am: "0 9 * * *"',
    '- Every Monday at 10am: "0 10 * * 1"',
    '- Every hour: "0 * * * *"',
    '- Every day at 8pm: "0 20 * * *"',
    '- Weekdays at 9am: "0 9 * * 1-5"',
    'Action types: send_digest, send_reminder, run_backup',
    'When user describes a process in natural language, parse it into the correct schedule and action type.',
    '',
