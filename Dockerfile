...
LABEL org.opencontainers.image.title="HAClaw-OS" \
      ...
      org.opencontainers.image.url="https://github.com/haniakrim21/HAClaw-OS" \
      org.opencontainers.image.documentation="https://github.com/haniakrim21/HAClaw-OS#readme" \
      org.opencontainers.image.source="https://github.com/haniakrim21/HAClaw-OS" \
